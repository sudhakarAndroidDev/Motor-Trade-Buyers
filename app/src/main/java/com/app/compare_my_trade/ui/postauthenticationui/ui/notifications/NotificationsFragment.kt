...
//        recyclerview3.layoutManager = LinearLayoutManager(activity)
    ...
    private fun MarkAll() {
        val URL = "http://motortraders.zydni.com/api/buyers/notification/mark-all-as-read"
...
//                Log.i("jdhfisd",response.toString())
                ...
                adapter2.setOnItemClickListener(object : NotificationAdapter.onItemClickListener{
                    override fun onItemClick(position: Int) {
                        ...
                        val URL = "http://motortraders.zydni.com/api/buyers/notification/mark-as-read/"+n_id
    ...
    private fun latest() {
        val URL = "http://motortraders.zydni.com/api/buyers/notification/list/5"
...
//                Log.i("jdhfisd",response.toString())
                ...
                adapter.setOnItemClickListener(object : NotificationAdapter.onItemClickListener{
                    override fun onItemClick(position: Int) {
                        ...
                        val URL =
                            "http://motortraders.zydni.com/api/buyers/notification/mark-as-read/" + n_id
                        ...
                        val request: StringRequest = object : StringRequest(
                            ...
                            override fun getHeaders(): Map<String, String> {
                                ...
                                headers.put("Authorization",
                                    "Bearer " + PreferenceUtils.getTokan(activity))
                                return headers
                            }
